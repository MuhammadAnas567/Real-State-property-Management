...
const { createBooking, getAllBookings, getMyBookings, deleteBooking, searchBooking, confirmBooking, getAllBookingsCounts } = require("../controllers/bookingController");
